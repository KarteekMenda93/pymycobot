...
class Object_detect():
    ...
    def __init__(self, camera_x = 160, camera_y = 15):
        ...
        # 移动坐标
        self.move_coords = [
            [132, -136.9, 200.8, -178.24, -3.72, -1.71],  # D Sorting area
        ...
        # set color HSV
        self.HSV = {#"blue": [np.array([100, 43, 46]), np.array([124, 255, 255])],
            "red": [np.array([0, 43, 46]), np.array([8, 255, 255])],# first block
            "yellow": [np.array([11, 85, 70]), np.array([59, 255, 245])],# second block
        }
    ...
    def move(self, x, y, color):
        ...
        self.mc.send_coords(self.move_coords[3], 40, 1)
        time.sleep(3)
        ...
        self.mc.send_angles(self.move_angles[0], 25)# move to the corresponding cordinates
        time.sleep(4.5)
    ...
    def decide_move(self, x, y, color):
        ...
        if (abs(x - self.cache_x) + abs(y - self.cache_y)) / 2 > 5:  # mm
            ...
            self.cache_x = self.cache_y = 0
            if (color==0):
                 self.move_coords[0]=[x,y, 204,-178, -3.7, -107]# red cordinates adjustment
#                self.move_coords[3]=[x,y, 204,-178, -3.7, -107]
                 self.move_coords[3]=[x,y, 149,-178, -3.7, -107]# yellow cordinates adjustment
